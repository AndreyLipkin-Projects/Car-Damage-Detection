...
class Ui_HyperparametersPage(object):
    def setupUi(self, HyperparametersPage):
        ...
        self.LearningRateSpinBox.setGeometry(QtCore.QRect(245, 27, 62, 22))
        ...
        self.L1RegularizationSpinBox.setGeometry(QtCore.QRect(245, 57, 62, 22))
        self.L1RegularizationSpinBox.setDecimals(2)
        self.L1RegularizationSpinBox.setMaximum(9999.0)
        self.L1RegularizationSpinBox.setProperty("value", 0.0)
        ...
        self.ValBatchSizeSpinBox.setGeometry(QtCore.QRect(245, 87, 62, 22))
        ...
        self.TrainBatchSizeSpinBox.setGeometry(QtCore.QRect(245, 117, 62, 22))
        ...
        self.epochsSpinBox.setGeometry(QtCore.QRect(245, 147, 62, 22))
    ...
    def retranslateUi(self, HyperparametersPage):
        ...
        self.trainingPercentageLineEdit.setText(_translate("HyperparametersPage", "80%"))
        self.validationPercentageLineEdit.setText(_translate("HyperparametersPage", "20%"))
        self.trainingPercentageLabel.setText(_translate("HyperparametersPage", "Training"))
        self.validationPercentageLabel.setText(_translate("HyperparametersPage", "Validation"))
