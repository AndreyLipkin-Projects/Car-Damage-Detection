...
class Ui_LoginWindow(object):
    def setupUi(self, LoginWindow):
        ...
        self.pushButton.setGeometry(QtCore.QRect(110, 240, 91, 17))
        self.pushButton.setObjectName("pushButton")
        self.pushButton_2 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_2.setGeometry(QtCore.QRect(110, 270, 91, 16))
        self.pushButton_2.setObjectName("pushButton_2")
        self.pushButton_3 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_3.setGeometry(QtCore.QRect(130, 310, 56, 17))
        self.pushButton_3.setObjectName("pushButton_3")
        self.pushButton_4 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_4.setGeometry(QtCore.QRect(0, 310, 56, 17))
    ...
    def retranslateUi(self, LoginWindow):
        ...
        LoginWindow.setWindowTitle(_translate("LoginWindow", "MainMenu"))
        ...
        self.pushButton.setText(_translate("LoginWindow", "Get damage localization"))
        self.pushButton_2.setText(_translate("LoginWindow", "View images"))
        self.pushButton_3.setText(_translate("LoginWindow", "Back"))
        self.pushButton_4.setText(_translate("LoginWindow", "Settings"))
